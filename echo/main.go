...
func makeBasicHost(listenPort int, insecure bool, randseed int64) (host.Host, error) {
	...
	// /ip4/127.0.0.1/tcp/10000/p2p/QmYo41GybvrXk8y8Xnm1P7pfA4YEXCpfnLyzgRPnNbG35e
	hostAddr, _ := ma.NewMultiaddr(fmt.Sprintf("/ipfs/%s", basicHost.ID().Pretty()))
	// hostAddr = /ipfs/QmYo41GybvrXk8y8Xnm1P7pfA4YEXCpfnLyzgRPnNbG35e
	// addr =
...
func main() {
	...
	listenF := flag.Int("l", 6666, "wait for incoming connections")
